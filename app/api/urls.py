...
from app.api.routes import players, teams, user, fixtures_and_standings, votes, custom_player, player_attributes, countries, formations
...
api_router.include_router(player_attributes.router, prefix="/player-att", tags=["Player Attributes"])
